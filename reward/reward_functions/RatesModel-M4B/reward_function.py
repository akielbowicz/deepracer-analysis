...
class Reward(RewardBase):
    ...
    def speed_lock(self):
        return 1.0 if self.speed <= self.speed_dynamic_threshold() else 1e-4
        
    def speed_dynamic_threshold(self):
        return self.SPEED_THRESHOLD_MIN if self.progress < 50.0 else self.SPEED_THRESHOLD_MAX
